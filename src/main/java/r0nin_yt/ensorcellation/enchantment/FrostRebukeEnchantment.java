...
import static r0nin_yt.core.init.CoreMobEffects.CHILLED;
import static r0nin_yt.core.init.CoreParticles.FROST;
import static r0nin_yt.core.util.references.EnsorcIDs.ID_DISPLACEMENT;
import static r0nin_yt.core.util.references.EnsorcIDs.ID_FIRE_REBUKE;
import static r0nin_yt.ensorcellation.Ensorcellation.ENCHANTMENTS;
import static r0nin_yt.lib.util.Constants.ARMOR_SLOTS;
